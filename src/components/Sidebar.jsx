...
const Sidebar = () => {
  ...
  const normalLik = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-md text-gray-700 dark:text-gray-200 dark:hover:text-black hover:bg-light-gray m-2'
              ...
              <TooltipComponent content="menu" position="BottomCenter">
                  <button type='button' onClick={() => setActiveMenu(
                    (prevActiveMenu) => !prevActiveMenu
                      ...
                      hover:bg-light-gray mt-4 block mt-4 lg:block md:hidden'>
                    <MdOutlineCancel/>
                  </button>
              </TooltipComponent>
          </div>
                ...
                <div key={item.title}>
                  ...
                  {item.links.map((link) => (
                    <NavLink 
                      ...
                      className = {({isActive}) => isActive? activeLink : normalLik }
                    >
                      {link.icon}
                      <span>
                        {link.name}
